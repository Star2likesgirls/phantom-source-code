...
class StringBox extends Screen {
   ...
   public void render(DrawContext drawContext, int n, int n2, float n3) {
      ...
      int a2 = MathUtil.clampInt(TextRenderer.getWidth(this.content) + 80, 600, this.this$0.mc.getWindow().getWidth() - 100);
      int n4 = (width2 - a2) / 2;
      int n5 = (height2 - 120) / 2;
      RenderUtils.renderRoundedQuad(drawContext.getMatrices(), new Color(30, 30, 35, 240), (double)n4, (double)n5, (double)(n4 + a2), (double)(n5 + 120), (double)8.0F, (double)8.0F, (double)8.0F, (double)8.0F, (double)20.0F);
      RenderUtils.renderRoundedQuad(drawContext.getMatrices(), new Color(40, 40, 45, 255), (double)n4, (double)n5, (double)(n4 + a2), (double)(n5 + 30), (double)8.0F, (double)8.0F, (double)0.0F, (double)0.0F, (double)20.0F);
      ...
      int n7 = n5 + 50;
      int n8 = a2 - 40;
      RenderUtils.renderRoundedQuad(drawContext.getMatrices(), new Color(20, 20, 25, 255), (double)n6, (double)n7, (double)(n6 + n8), (double)(n7 + 30), (double)5.0F, (double)5.0F, (double)5.0F, (double)5.0F, (double)20.0F);
      RenderUtils.renderRoundedOutline(drawContext, new Color(60, 60, 65, 255), (double)n6, (double)n7, (double)(n6 + n8), (double)(n7 + 30), (double)5.0F, (double)5.0F, (double)5.0F, (double)5.0F, (double)1.0F, (double)20.0F);
      ...
      int n13 = n4 + a2 - 80 - 20;
      int n14 = n13 - 80 - 10;
      RenderUtils.renderRoundedQuad(drawContext.getMatrices(), Utils.getMainColor(255, 1), (double)n13, (double)n12, (double)(n13 + 80), (double)(n12 + 25), (double)5.0F, (double)5.0F, (double)5.0F, (double)5.0F, (double)20.0F);
      TextRenderer.drawCenteredString("Save", drawContext, n13 + 40, n12 + 6, (new Color(245, 245, 245, 255)).getRGB());
      RenderUtils.renderRoundedQuad(drawContext.getMatrices(), new Color(60, 60, 65, 255), (double)n14, (double)n12, (double)(n14 + 80), (double)(n12 + 25), (double)5.0F, (double)5.0F, (double)5.0F, (double)5.0F, (double)20.0F);
   ...
   public boolean mouseClicked(double n, double n2, int n3) {
      ...
      int width = this.this$0.mc.getWindow().getWidth();
      int height = this.this$0.mc.getWindow().getHeight();
      int max = Math.max(600, MathUtil.clampInt(TextRenderer.getWidth(this.content) + 80, 400, this.this$0.mc.getWindow().getWidth() - 100));
      int n6 = (height - 120) / 2 + 120 - 30;
   ...
   public boolean keyPressed(int n, int n2, int n3) {
      ...
      if (n == 256) {
         ...
         if (this.selectionStart != -1 && this.selectionStart != this.cursorPosition) {
            ...
            String var11 = this.content.substring(0, min2);
            this.content = var11 + this.content.substring(max);
         ...
         if (this.selectionStart != -1 && this.selectionStart != this.cursorPosition) {
            ...
            String var10 = this.content.substring(0, this.cursorPosition - 1);
            this.content = var10 + this.content.substring(this.cursorPosition);
            --this.cursorPosition;
         }
         ...
         if (this.selectionStart != -1 && this.selectionStart != this.cursorPosition) {
            ...
            String var10001 = this.content.substring(0, this.cursorPosition);
